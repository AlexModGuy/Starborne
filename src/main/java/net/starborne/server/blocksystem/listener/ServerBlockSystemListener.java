package net.starborne.server.blocksystem.listener;
...
public class ServerBlockSystemListener implements IWorldEventListener {
    ...
    public void playEvent(EntityPlayer player, int type, BlockPos pos, int data) {
        ...
        Starborne.NETWORK_WRAPPER.sendToAllAround(new PlayEventMessage(this.blockSystem, pos, type, data, false), new NetworkRegistry.TargetPoint(this.blockSystem.getMainWorld().provider.getDimension(), transformed.xCoord, transformed.yCoord, transformed.zCoord, 64.0));
    }
